...
/* accept pair */
func AttachSyscallAcceptEntry1() (link.Link, error) {
	return Tracepoint("syscalls", "sys_enter_accept", GetProgramFromObjs(Objs, "TracepointSyscallsSysEnterAccept"))
}

func AttachSyscallAcceptExit1() (link.Link, error) {
	return Tracepoint("syscalls", "sys_exit_accept", GetProgramFromObjs(Objs, "TracepointSyscallsSysExitAccept"))
}
...
func AttachKProbeIpQueueXmitEntry() (link.Link, error) {
	return Kprobe("ip_queue_xmit", GetProgramFromObjs(Objs, "IpQueueXmit"))
}
